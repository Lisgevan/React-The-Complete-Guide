...
//functional based use of redux library
...
const Counter = () => {
	...
	const increaseHandler = () => {
		dispatch(counterActions.increease(10));
	};
...
// //class based use of redux library
...
// //adds functions to props object
