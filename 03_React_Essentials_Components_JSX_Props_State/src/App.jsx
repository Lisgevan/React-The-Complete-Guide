		...
		<div>
			...
			<main>
				<section id="core-concepts">
					<h2>Core Concepts</h2>
					<ul>
						{/* {CORE_CONCEPTS.map((coreConcept, indx) => (
							<CoreConcept
								key={indx}
						...
						{/* one line code of the above using the spread operator */}
						{CORE_CONCEPTS.map((coreConcept, indx) => (
							<CoreConcept key={indx} {...coreConcept} />
						))}
						{/* <CoreConcept
				...
				<section id="examples">
					...
					{/* second way of writing the above */}
					...
					{/* Third way to write the above using a variable */}
					{tabContent}
				</section>
			</main>
		</div>
